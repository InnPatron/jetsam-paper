...
\begin{document}
	...
	An early sketch for a specification of a Pyret binding generator for TypeScript code based on augmented simply-typed lambda calculi and source-type indexed logical relations as outlined by \textcite{FFI}.
...
%*********************************************
%*********************************************	
	\section{Compiler $TS_{NUM}$ to Target $L$}
...
%*********************************************
%*********************************************	
	\section{Compiler $PY_{NUM}$ to Target $L$}
...
%*********************************************
	...
	Let $\mathcal{E}[T]$ be the set of all possible expressions of type $T$ that do \textbf{not} evaluate to `fail'.
